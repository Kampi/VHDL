...

{
	...
	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 536352, dp + 530080, 0, 31, 0, 31, 32, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 536392, dp + 530192, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 536472, dp + 530416, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 536672, dp + 537856, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 536728, dp + 537912, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 536592, dp + 538024, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 619152, dp + 530640, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 619264, dp + 530752, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 619208, dp + 530864, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 619320, dp + 530976, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 620952, dp + 622056, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 621120, dp + 621944, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 776016, dp + 776720, 0, 6, 0, 6, 7, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 776056, dp + 776664, 0, 0, 0, 0, 1, 1);

}

void simulate(char *dp)
{
iki_register_root_pointers(9, 82008, 41,2, 0, 32,83592, 38,0,0,80056, 12,1,0,80232, 14,1,0,93224, -5,0,87824, 45,0,101864, -7,0,256336, 12,0,0,81080, 34,1,0) ; 
...
int main(int argc, char **argv)
{
    ...
    iki_svlog_initialize_virtual_tables(17, 36, ng360, 35, ng350, 14, ng140, 24, ng240, 13, ng130, 21, ng210, 12, ng120, 23, ng230, 22, ng220, 31, ng310, 34, ng340, 33, ng330, 30, ng300, 39, ng390, 20, ng200, 29, ng290, 38, ng380);
