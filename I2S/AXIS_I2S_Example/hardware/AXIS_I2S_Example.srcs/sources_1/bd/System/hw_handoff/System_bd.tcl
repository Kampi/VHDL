...
proc create_root_design { parentCell } {
  ...
  # Create instance: AXIS_I2S_Transmitter_0, and set properties
  set AXIS_I2S_Transmitter_0 [ create_bd_cell -type ip -vlnv www.Kampis-Elektroecke.com:Kampis-Elektroecke:AXIS_I2S_Transmitter:1.0 AXIS_I2S_Transmitter_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_IMPORT_BOARD_PRESET {D:/Downloads/Zybo.xml} \
  ...
  # Create instance: ProcessingSystem_axi_periph, and set properties
  set ProcessingSystem_axi_periph [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 ProcessingSystem_axi_periph ]
  set_property -dict [ list \
   CONFIG.NUM_MI {1} \
 ] $ProcessingSystem_axi_periph
  ...
  connect_bd_intf_net -intf_net FIFO_AXI_STR_TXD [get_bd_intf_pins AXIS_I2S_Transmitter_0/AXIS_RXD] [get_bd_intf_pins FIFO/AXI_STR_TXD]
  ...
  connect_bd_intf_net -intf_net ProcessingSystem_M_AXI_GP0 [get_bd_intf_pins ProcessingSystem/M_AXI_GP0] [get_bd_intf_pins ProcessingSystem_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ProcessingSystem_axi_periph_M00_AXI [get_bd_intf_pins FIFO/S_AXI] [get_bd_intf_pins ProcessingSystem_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net AXIS_I2S_Transmitter_0_DataOut [get_bd_pins AXIS_I2S_Transmitter_0/DataOut] [get_bd_pins vio_0/probe_in0]
  connect_bd_net -net AXIS_I2S_Transmitter_0_LRCLK [get_bd_ports LRCLK] [get_bd_pins AXIS_I2S_Transmitter_0/LRCLK]
  connect_bd_net -net AXIS_I2S_Transmitter_0_SCLK [get_bd_ports SCLK] [get_bd_pins AXIS_I2S_Transmitter_0/SCLK]
  connect_bd_net -net AXIS_I2S_Transmitter_0_SD [get_bd_ports SD] [get_bd_pins AXIS_I2S_Transmitter_0/SD]
  connect_bd_net -net ClockingWizard_ClkAudio [get_bd_ports MCLK] [get_bd_pins AXIS_I2S_Transmitter_0/MCLK] [get_bd_pins ClockingWizard/ClkAudio] [get_bd_pins Reset_Audio/slowest_sync_clk]
  connect_bd_net -net ClockingWizard_locked [get_bd_pins ClockingWizard/locked] [get_bd_pins Reset_Audio/dcm_locked] [get_bd_pins Reset_ProcessingSystem/dcm_locked]
  connect_bd_net -net FIFO_interrupt [get_bd_pins FIFO/interrupt] [get_bd_pins ProcessingSystem/IRQ_F2P]
  connect_bd_net -net ProcessingSystem_FCLK_CLK0 [get_bd_pins AXIS_I2S_Transmitter_0/aclk] [get_bd_pins FIFO/s_axi_aclk] [get_bd_pins ProcessingSystem/FCLK_CLK0] [get_bd_pins ProcessingSystem/M_AXI_GP0_ACLK] [get_bd_pins ProcessingSystem_axi_periph/ACLK] [get_bd_pins ProcessingSystem_axi_periph/M00_ACLK] [get_bd_pins ProcessingSystem_axi_periph/S00_ACLK] [get_bd_pins Reset_ProcessingSystem/slowest_sync_clk] [get_bd_pins vio_0/clk]
  connect_bd_net -net ProcessingSystem_FCLK_RESET0_N [get_bd_pins ClockingWizard/resetn] [get_bd_pins ProcessingSystem/FCLK_RESET0_N] [get_bd_pins Reset_Audio/ext_reset_in] [get_bd_pins Reset_ProcessingSystem/ext_reset_in]
  connect_bd_net -net Reset_Audio_peripheral_aresetn [get_bd_pins AXIS_I2S_Transmitter_0/Audio_Reset] [get_bd_pins Reset_Audio/peripheral_aresetn]
  connect_bd_net -net Reset_ProcessingSystem_peripheral_aresetn [get_bd_pins AXIS_I2S_Transmitter_0/aresetn] [get_bd_pins FIFO/s_axi_aresetn] [get_bd_pins ProcessingSystem_axi_periph/ARESETN] [get_bd_pins ProcessingSystem_axi_periph/M00_ARESETN] [get_bd_pins ProcessingSystem_axi_periph/S00_ARESETN] [get_bd_pins Reset_ProcessingSystem/peripheral_aresetn]
  connect_bd_net -net clk_in1_0_1 [get_bd_ports Clock125] [get_bd_pins ClockingWizard/clk_in1]
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins AXIS_I2S_Transmitter_0/ReadyIn] [get_bd_pins vio_0/probe_out0]
