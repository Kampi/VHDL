...
proc create_root_design { parentCell } {
  ...
  set AXI_Peripherals [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 AXI_Peripherals ]
  set_property -dict [ list \
   CONFIG.NUM_MI {1} \
 ] $AXI_Peripherals
  ...
  connect_bd_intf_net -intf_net ProcessingSystem_M_AXI_GP0 [get_bd_intf_pins AXI_Peripherals/S00_AXI] [get_bd_intf_pins ProcessingSystem/M_AXI_GP0]
  connect_bd_intf_net -intf_net ProcessingSystem_axi_periph_M00_AXI [get_bd_intf_pins AXI_Peripherals/M00_AXI] [get_bd_intf_pins FIFO/S_AXI]
  ...
  connect_bd_net -net ClockingWizard_ClkAudio [get_bd_ports MCLK] [get_bd_pins AXIS_I2S_Transmitter_0/MCLK] [get_bd_pins ClockingWizard/ClkAudio]
  connect_bd_net -net ClockingWizard_locked [get_bd_pins ClockingWizard/locked] [get_bd_pins Reset_ProcessingSystem/dcm_locked]
  connect_bd_net -net FIFO_interrupt [get_bd_pins FIFO/interrupt] [get_bd_pins ProcessingSystem/IRQ_F2P]
  connect_bd_net -net ProcessingSystem_FCLK_CLK0 [get_bd_pins AXIS_I2S_Transmitter_0/aclk] [get_bd_pins AXI_Peripherals/ACLK] [get_bd_pins AXI_Peripherals/M00_ACLK] [get_bd_pins AXI_Peripherals/S00_ACLK] [get_bd_pins FIFO/s_axi_aclk] [get_bd_pins ProcessingSystem/FCLK_CLK0] [get_bd_pins ProcessingSystem/M_AXI_GP0_ACLK] [get_bd_pins Reset_ProcessingSystem/slowest_sync_clk]
  connect_bd_net -net ProcessingSystem_FCLK_RESET0_N [get_bd_pins ClockingWizard/resetn] [get_bd_pins ProcessingSystem/FCLK_RESET0_N] [get_bd_pins Reset_ProcessingSystem/ext_reset_in]
  connect_bd_net -net Reset_ProcessingSystem_peripheral_aresetn [get_bd_pins AXIS_I2S_Transmitter_0/aresetn] [get_bd_pins AXI_Peripherals/ARESETN] [get_bd_pins AXI_Peripherals/M00_ARESETN] [get_bd_pins AXI_Peripherals/S00_ARESETN] [get_bd_pins FIFO/s_axi_aresetn] [get_bd_pins Reset_ProcessingSystem/peripheral_aresetn]
