...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Reset_Audio_peripheral_aresetn [get_bd_pins AXIS_I2S_Transmitter_0/nReset] [get_bd_pins Reset_Audio/peripheral_aresetn]
