...
architecture STRUCTURE of StreamWriter is
  ...
  attribute X_INTERFACE_PARAMETER of ACLK : signal is "XIL_INTERFACENAME CLK.ACLK, ASSOCIATED_RESET ARESETn, CLK_DOMAIN StreamWriter_ACLK, FREQ_HZ 125000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000";
  attribute X_INTERFACE_INFO of ARESETn : signal is "xilinx.com:signal:reset:1.0 RST.ARESETN RST";
  attribute X_INTERFACE_PARAMETER of ARESETn : signal is "XIL_INTERFACENAME RST.ARESETN, INSERT_VIP 0, POLARITY ACTIVE_LOW";
begin
  TDATA(31 downto 0) <= StreamWriter_m_axis_tdata(31 downto 0);
  TLAST(0) <= StreamWriter_m_axis_tlast(0);
  TVALID(0) <= StreamWriter_m_axis_tvalid(0);
  aclk_0_1 <= ACLK;
  aresetn_0_1 <= ARESETn;
